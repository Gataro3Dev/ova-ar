...
public class solucion_conflicto : MonoBehaviour {
	bool [] estado = {false, false, false, false};
	private Ray pulso;
	...
	private GameObject [] calificacion = {null, null, null, null};
	...
	public void presionar_Boton(){	
		sonido.clip = boton;
		sonido.Play ();
		Destroy (GameObject.Find ("Pagina_13UI(Clone)"));
		estadoJuego = true;
	}
